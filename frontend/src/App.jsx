...
const initThree = async (userImageUrl) => {
  ...
  textureLoader.load(
    ...
    // Load clothing texture if available
    // / Load the clothing texture overlay if available
    if (clothingTexture) {
      ...
      textureLoader.load(
        ...
        (texture) => {
          ...
          clothingPlane.position.set(0, 0, 0.2);  // Slightly in front of the user image
